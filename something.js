...
Roblox.LangDynamic["Authentication.CrossDevice"] = {
    ...
    "Heading.LoginWarning": "You are unable to do this action right now:",
    "Label.Warning1": "• Please do not try to use this",
    "Label.Warning2": "• Verify your account first",
    "Label.EnterCode": "Enter Quick Sign In Code",
    "Action.Enter": "Enter",
    "Heading.Warning": "WARNING!",
    "Label.ConfirmationMessage2": "This new device will receive access to your account, Robux, and inventory.",
    ...
    "Response.InvalidCode": "The code you entered was invalid. Please make sure you entered it correctly.",
    ...
    "InvalidLocationError": "We couldn't match your location to the device trying to log in. Please try again on the same network.",
    "Label.InvalidLocationError": "We couldn't match your location to the device trying to log in. Please try again on the same network.",
    ...
    "Label.LoginLocationWithIcons": "{settingsIcon} or {moreIcon} <b> > Quick Log In</b> to enter this code on that device.",
